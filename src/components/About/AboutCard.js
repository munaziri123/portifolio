    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          <footer className="blockquote-footer">MUNAZIRI Josue</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
